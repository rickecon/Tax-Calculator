...
II_em_Ingram = {"2026": 20000}


@iterate_jit(nopython=True)
def AGI_Ingram(
    ymod1, c02500, c02900, XTOT, MARS, sep, DSI, exact, nu18, taxable_ubi,
    II_em_Ingram, II_em_ps, II_prt, e02300, UI_thd, UI_em,
...
ID_c_Ingram = {"2026": [0,0,0,0,0]}


@iterate_jit(nopython=True)
def ItemDed_Ingram(
    e17500_capped, e18400_capped, e18500_capped, e19200_capped, e19800_capped,
    e20100_capped, e20400_capped, g20500_capped, MARS, age_head, age_spouse,
    c00100, c04470, c21040, c21060, c17000, c18300, c19200, c19700, c20500,
    c20800, ID_ps, ID_Medical_frt, ID_Medical_frt_add4aged, ID_Medical_hc,
    ID_Casualty_frt, ID_Casualty_hc, ID_Miscellaneous_frt, ID_Miscellaneous_hc,
    ID_Charity_crt_cash, ID_Charity_crt_noncash, ID_prt, ID_crt, ID_c_Ingram,
    ID_StateLocalTax_hc, ID_Charity_frt, ID_Charity_hc, ID_InterestPaid_hc,
    ID_RealEstate_hc, ID_Medical_c, ID_StateLocalTax_c, ID_RealEstate_c,
    ID_InterestPaid_c, ID_Charity_c, ID_Casualty_c, ID_Miscellaneous_c,
    ID_AllTaxes_c, ID_AllTaxes_hc, ID_StateLocalTax_crt, ID_RealEstate_crt,
    ID_Charity_f
):
    """
    Calculates itemized deductions, Form 1040, Schedule A.
    ...
    if c21060 > nonlimited and c00100 > limitstart:
        ...
        c21040 = 0.
        c04470 = c21060
    c04470 = min(c04470, ID_c_Ingram[MARS - 1])
    # Return total itemized deduction amounts and components
    return (c17000, c18300, c19200, c19700, c20500, c20800,
            c21040, c21060, c04470)
...
STD_Ingram = {"2026": [25000,50000,50000,25000,25000]}
STD_Aged_Ingram = {"2026": [0,0,0,0,0]}
...
PT_rt1_Ingram = {"2026": 0.2}
PT_rt2_Ingram = {"2026": 0.2}
PT_rt3_Ingram = {"2026": 0.2}
PT_rt4_Ingram = {"2026": 0.2}
PT_rt5_Ingram = {"2026": 0.2}
PT_rt6_Ingram = {"2026": 0.2}
PT_rt7_Ingram = {"2026": 0.2}
PT_rt8_Ingram = {"2026": 0.2}

II_rt1_Ingram = {"2026": 0.2}
II_rt2_Ingram = {"2026": 0.2}
II_rt3_Ingram = {"2026": 0.2}
II_rt4_Ingram = {"2026": 0.2}
II_rt5_Ingram = {"2026": 0.2}
II_rt6_Ingram = {"2026": 0.2}
II_rt7_Ingram = {"2026": 0.2}
II_rt8_Ingram = {"2026": 0.2}


@JIT(nopython=True)
def SchXYZ_Ingram(
    taxable_income, MARS, e00900, e26270, e02000, e00200, PT_rt1_Ingram,
    PT_rt2_Ingram, PT_rt3_Ingram, PT_rt4_Ingram, PT_rt5_Ingram, PT_rt6_Ingram,
    PT_rt7_Ingram, PT_rt8_Ingram, PT_brk1, PT_brk2, PT_brk3, PT_brk4, PT_brk5,
    PT_brk6, PT_brk7, II_rt1_Ingram, II_rt2_Ingram, II_rt3_Ingram,
    II_rt4_Ingram, II_rt5_Ingram, II_rt6_Ingram, II_rt7_Ingram, II_rt8_Ingram,
    II_brk1, II_brk2, II_brk3, II_brk4, II_brk5, II_brk6, II_brk7,
    PT_EligibleRate_active, PT_EligibleRate_passive, PT_wages_active_income,
    PT_top_stacking
):
    """
    Returns Schedule X, Y, Z tax amount for specified taxable_income.
    ...
    if reg_taxinc > 0.:
        reg_tax = Taxes(
            reg_taxinc, MARS, reg_tbase, II_rt1_Ingram, II_rt2_Ingram,
            II_rt3_Ingram, II_rt4_Ingram, II_rt5_Ingram, II_rt6_Ingram,
            II_rt7_Ingram, II_rt8_Ingram, II_brk1, II_brk2, II_brk3, II_brk4,
    ...
    if pt_taxinc > 0.:
        pt_tax = Taxes(
            pt_taxinc, MARS, pt_tbase, PT_rt1_Ingram, PT_rt2_Ingram,
            PT_rt3_Ingram, PT_rt4_Ingram, PT_rt5_Ingram, PT_rt6_Ingram,
            PT_rt7_Ingram, PT_rt8_Ingram, PT_brk1, PT_brk2, PT_brk3, PT_brk4,
...
@iterate_jit(nopython=True)
def SchXYZTax_Ingram(
    c04800, MARS, e00900, e26270, e02000, e00200, PT_rt1_Ingram, PT_rt2_Ingram,
    PT_rt3_Ingram, PT_rt4_Ingram, PT_rt5_Ingram, PT_rt6_Ingram, PT_rt7_Ingram,
    PT_rt8_Ingram, PT_brk1, PT_brk2, PT_brk3, PT_brk4, PT_brk5, PT_brk6,
    PT_brk7, II_rt1_Ingram, II_rt2_Ingram, II_rt3_Ingram, II_rt4_Ingram,
    II_rt5_Ingram, II_rt6_Ingram, II_rt7_Ingram, II_rt8_Ingram, II_brk1,
    II_brk2, II_brk3, II_brk4, II_brk5, II_brk6, II_brk7,
    PT_EligibleRate_active, PT_EligibleRate_passive, PT_wages_active_income,
    PT_top_stacking, c05200
):
    """
    SchXYZTax_Ingram calls SchXYZ function and sets c05200 to returned amount.
    ...
    """
    c05200 = SchXYZ(
        c04800, MARS, e00900, e26270, e02000, e00200, PT_rt1_Ingram,
        PT_rt2_Ingram, PT_rt3_Ingram, PT_rt4_Ingram, PT_rt5_Ingram,
        PT_rt6_Ingram, PT_rt7_Ingram, PT_rt8_Ingram, PT_brk1, PT_brk2, PT_brk3,
        PT_brk4, PT_brk5, PT_brk6, PT_brk7, II_rt1_Ingram, II_rt2_Ingram,
        II_rt3_Ingram, II_rt4_Ingram, II_rt5_Ingram, II_rt6_Ingram,
        II_rt7_Ingram, II_rt8_Ingram, II_brk1, II_brk2, II_brk3, II_brk4,
        II_brk5, II_brk6, II_brk7, PT_EligibleRate_active,
        PT_EligibleRate_passive, PT_wages_active_income, PT_top_stacking
    )
    return c05200
...
CG_rt1_Ingram = {"2026": 0.2}
CG_rt2_Ingram = {"2026": 0.2}
CG_rt3_Ingram = {"2026": 0.2}
CG_rt4_Ingram = {"2026": 0.2}


@iterate_jit(nopython=True)
def GainsTax_Ingram(
    e00650, c01000, c23650, p23250, e01100, e58990, e00200, e24515, e24518,
    MARS, c04800, c05200, e00900, e26270, e02000, II_rt1_Ingram, II_rt2_Ingram,
    II_rt3_Ingram, II_rt4_Ingram, II_rt5_Ingram, II_rt6_Ingram, II_rt7_Ingram,
    II_rt8_Ingram, II_brk1, II_brk2, II_brk3, II_brk4, II_brk5, II_brk6,
    II_brk7, PT_rt1_Ingram, PT_rt2_Ingram, PT_rt3_Ingram, PT_rt4_Ingram,
    PT_rt5_Ingram, PT_rt6_Ingram, PT_rt7_Ingram, PT_rt8_Ingram, PT_brk1,
    PT_brk2, PT_brk3, PT_brk4, PT_brk5, PT_brk6, PT_brk7, CG_nodiff,
    PT_EligibleRate_active, PT_EligibleRate_passive, PT_wages_active_income,
    PT_top_stacking, CG_rt1_Ingram, CG_rt2_Ingram, CG_rt3_Ingram,
    CG_rt4_Ingram, CG_brk1, CG_brk2, CG_brk3, dwks10, dwks13, dwks14, dwks19,
    dwks43, c05700, taxbc
):
    """
    GainsTax function implements (2015) Schedule D Tax Worksheet logic for
    ...
    if hasqdivltcg == 1:
        ...
        dwks19 = max(dwks17, dwks18)
        dwks20 = dwks16 - dwks17
        lowest_rate_tax = CG_rt1_Ingram * dwks20
        # break in worksheet lines
        dwks21 = min(dwks1, dwks13)
        dwks22 = dwks20
        dwks23 = max(0., dwks21 - dwks22)
        ...
        dwks27 = max(0., dwks25 - dwks26)
        dwks28 = min(dwks23, dwks27)
        dwks29 = CG_rt2_Ingram * dwks28
        dwks30 = dwks22 + dwks28
        dwks31 = dwks21 - dwks30
        dwks32 = CG_rt3_Ingram * dwks31
        # compute total taxable CG for additional top bracket
        cg_all = dwks20 + dwks28 + dwks31
        hi_base = max(0., cg_all - CG_brk3[MARS - 1])
        hi_incremental_rate = CG_rt4_Ingram - CG_rt3_Ingram
        highest_rate_incremental_tax = hi_incremental_rate * hi_base
        # break in worksheet lines
        dwks33 = min(dwks9, e24515)
        dwks34 = dwks10 + dwks19
        ...
        dwks41 = 0.28 * dwks40
        dwks42 = SchXYZ(
            dwks19, MARS, e00900, e26270, e02000, e00200, PT_rt1_Ingram,
            PT_rt2_Ingram, PT_rt3_Ingram, PT_rt4_Ingram, PT_rt5_Ingram,
            PT_rt6_Ingram, PT_rt7_Ingram, PT_rt8_Ingram, PT_brk1, PT_brk2,
            PT_brk3, PT_brk4, PT_brk5, PT_brk6, PT_brk7, II_rt1_Ingram,
            II_rt2_Ingram, II_rt3_Ingram, II_rt4_Ingram, II_rt5_Ingram,
            II_rt6_Ingram, II_rt7_Ingram, II_rt8_Ingram, II_brk1, II_brk2,
            II_brk3, II_brk4, II_brk5, II_brk6, II_brk7,
            PT_EligibleRate_active, PT_EligibleRate_passive,
            PT_wages_active_income, PT_top_stacking
        )
        dwks43 = (dwks29 + dwks32 + dwks38 + dwks41 + dwks42 +
                  lowest_rate_tax + highest_rate_incremental_tax)
...
AMT_rt1_Ingram = {"2026": 0}
AMT_rt2_Ingram = {"2026": 0}
AMT_CG_rt1_Ingram = {"2026": 0}
AMT_CG_rt2_Ingram = {"2026": 0}
AMT_CG_rt3_Ingram = {"2026": 0}
AMT_CG_rt4_Ingram = {"2026": 0}


@iterate_jit(nopython=True)
def AMT_Ingram(
    e07300, dwks13, standard, f6251, c00100, c18300, taxbc, c04470, c17000,
    c20800, c21040, e24515, MARS, sep, dwks19, dwks14, c05700, e62900, e00700,
    dwks10, age_head, age_spouse, earned, cmbtp, qbided, AMT_child_em_c_age,
    AMT_brk1, AMT_em, AMT_prt, AMT_rt1_Ingram, AMT_rt2_Ingram, AMT_child_em,
    AMT_em_ps, AMT_em_pe, AMT_CG_brk1, AMT_CG_brk2, AMT_CG_brk3,
    AMT_CG_rt1_Ingram, AMT_CG_rt2_Ingram, AMT_CG_rt3_Ingram, AMT_CG_rt4_Ingram,
    ...
    AMT_prt: float
        AMT exemption phaseout rate
    AMT_rt1_Ingram: float
        AMT rate 1
    AMT_rt2_Ingram: float
        Additional AMT rate for AMT taxable income about AMT bracket 1
    AMT_child_em: float
        Child AMT exemption additional income base
    AMT_em_ps: list
    ...
    AMT_CG_brk3: list
        Top of long-term capital gains and qualified dividends (AMT) tax
        bracket 3
    AMT_CG_rt1_Ingram: float
        Long term capital gain and qualified dividends (AMT) rate 1
    AMT_CG_rt2_Ingram: float
        Long term capital gain and qualified dividends (AMT) rate 2
    AMT_CG_rt3_Ingram: float
        Long term capital gain and qualified dividends (AMT) rate 3
    AMT_CG_rt4_Ingram: float
        Long term capital gain and qualified dividends (AMT) rate 4
    c05800: float
        Total (regular + AMT) income tax liability before credits
    c09600: float
    ...
    if young_head and no_or_young_spouse:
        line29 = min(line29, earned + AMT_child_em)
    line30 = max(0., c62100 - line29)
    line3163 = (AMT_rt1_Ingram * line30 +
                AMT_rt2_Ingram * max(0., (line30 - (AMT_brk1 / sep))))
    if dwks10 > 0. or dwks13 > 0. or dwks14 > 0. or dwks19 > 0. or e24515 > 0.:
        # complete Form 6251, Part III (line36 is equal to line30)
        line37 = dwks13
        line38 = e24515
        ...
        line40 = min(line30, line39)
        line41 = max(0., line30 - line40)
        line42 = (AMT_rt1_Ingram * line41 +
                  AMT_rt2_Ingram * max(0., (line41 - (AMT_brk1 / sep))))
        line44 = dwks14
        line45 = max(0., AMT_CG_brk1[MARS - 1] - line44)
        line46 = min(line30, line37)
        line47 = min(line45, line46)  # line47 is amount taxed at AMT_CG_rt1
        cgtax1 = line47 * AMT_CG_rt1_Ingram
        line48 = line46 - line47
        line51 = dwks19
        line52 = line45 + line51
        line53 = max(0., AMT_CG_brk2[MARS - 1] - line52)
        line54 = min(line48, line53)  # line54 is amount taxed at AMT_CG_rt2
        cgtax2 = line54 * AMT_CG_rt2_Ingram
        line56 = line47 + line54  # total amount in lower two brackets
        if line41 == line56:
            line57 = 0.  # line57 is amount taxed at AMT_CG_rt3
            linex2 = 0.  # linex2 is amount taxed at AMT_CG_rt4
            ...
            linex1 = min(line48,
                         max(0., AMT_CG_brk3[MARS - 1] - line44 - line45))
            linex2 = max(0., line54 - linex1)
        cgtax3 = line57 * AMT_CG_rt3_Ingram
        cgtax4 = linex2 * AMT_CG_rt4_Ingram
        if line38 == 0.:
            line61 = 0.
        else:
            line61 = 0.25 * max(0., line30 - line41 - line56 - line57 - linex2)
...
@iterate_jit(nopython=True)
def EITC_Ingram(MARS, DSI, EIC, c00100, e00300, e00400, e00600, c01000,
         e02000, e26270, age_head, age_spouse, earned, earned_p, earned_s,
         EITC_ps, EITC_MinEligAge, EITC_MaxEligAge, EITC_ps_MarriedJ,
         EITC_rt, EITC_c_Ingram, EITC_prt, EITC_basic_frac,
         EITC_InvestIncome_c, EITC_excess_InvestIncome_rt,
         EITC_indiv, EITC_sep_filers_elig, c59660):
    """
    Computes EITC amount, c59660.
    ...
    if MARS != 2:
        eitc = EITCamount(EITC_basic_frac,
                          EITC_rt[EIC], earned, EITC_c_Ingram[EIC],
                          EITC_ps[EIC], c00100, EITC_prt[EIC])
        if EIC == 0:
            # enforce age eligibility rule for those with no EITC-eligible
            # kids assuming that an unknown age_* value implies EITC age
    ...
    if MARS == 2:
        ...
        if EITC_indiv:
            # individual EITC rather than a filing-unit EITC
            eitc_p = EITCamount(EITC_basic_frac,
                                EITC_rt[EIC], earned_p, EITC_c_Ingram[EIC],
                                po_start, earned_p, EITC_prt[EIC])
            eitc_s = EITCamount(EITC_basic_frac,
                                EITC_rt[EIC], earned_s, EITC_c_Ingram[EIC],
                                po_start, earned_s, EITC_prt[EIC])
            eitc = eitc_p + eitc_s
...
@iterate_jit(nopython=True)
def ChildDepTaxCredit_Ingram(
    age_head, age_spouse, nu18, n24, MARS, c00100, XTOT, num, c05800, e07260,
    CR_ResidentialEnergy_hc, e07300, CR_ForeignTax_hc, c07180, c07230, e07240,
    CR_RetirementSavings_hc, c07200, CTC_c_Ingram, CTC_ps, CTC_prt, exact,
    ODC_c_Ingram, CTC_c_under6_bonus, nu06, CTC_is_refundable, CTC_include17,
    c07220, odc, codtc_limited
):
    """
    Computes amounts on "Child Tax Credit and Credit for Other Dependents
    ...
    if CTC_include17:
        ...
        childnum = n24
    line1 = CTC_c_Ingram * childnum + CTC_c_under6_bonus * nu06
    line2 = ODC_c_Ingram * max(0, XTOT - childnum - num)
    line3 = line1 + line2
    modAGI = c00100  # no foreign earned income exclusion to add to AGI (line6)
    if line3 > 0. and modAGI > CTC_ps[MARS - 1]:
        excess = modAGI - CTC_ps[MARS - 1]
...
@iterate_jit(nopython=True)
def AdditionalCTC_Ingram(
    codtc_limited, ACTC_c_Ingram, n24, earned, ACTC_Income_thd, ACTC_rt, nu06,
    ACTC_rt_bonus_under6family, ACTC_ChildNum, CTC_is_refundable,
    CTC_include17, age_head, age_spouse, MARS, nu18, ptax_was, c03260, e09800,
    c59660, e11200, c11070
):
    """
    Calculates refundable Additional Child Tax Credit (ACTC), c11070,
    following 2018 Form 8812 logic.
